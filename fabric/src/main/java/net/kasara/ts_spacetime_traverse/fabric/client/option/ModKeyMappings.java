package net.kasara.ts_spacetime_traverse.fabric.client.option;
...
public class ModKeyMappings {
    ...
    public static void register() {
        POSITION_SWAP = KeyBindingHelper.registerKeyBinding(new KeyMapping(
        ...
        PORTAL_ACTION = KeyBindingHelper.registerKeyBinding(new KeyMapping(
