...
public class WaypointListWidget extends ObjectSelectionList<WaypointListWidget.Entry> {
     ...
     */
    @Override
    protected void renderSelection(GuiGraphics graphics, int top, int width, int height, int outlineColor, int fillColor) {
    ...
    public static class Entry extends ObjectSelectionList.Entry<WaypointListWidget.Entry> {
        ...
        private static final ResourceLocation TRUE_QUICK_ICON =
                ResourceLocation.fromNamespaceAndPath(TokorotenSlimeAPI.getModId(), "textures/item/spacetime_eye.png");
        private static final ResourceLocation FALSE_QUICK_ICON =
                ResourceLocation.fromNamespaceAndPath(TokorotenSlimeAPI.getModId(), "textures/gui/false_quick_icon.png");
